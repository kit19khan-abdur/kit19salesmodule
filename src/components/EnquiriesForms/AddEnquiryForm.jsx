                      ...
                      <div key={index} className="flex gap-2 items-center">
                        <div className="flex gap-2 flex-1">
                          ...
                          <input
                            ...
                            className="flex-1 px-3 py-2.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.tags}
                  onChange={handleChange}
                  className="w-full px-3 py-2.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 mb-2"
