...
const EditLeadForm = ({ lead, onClose, onSubmit }) => {
  const [formData, setFormData] = useState({
    ...
    medium: lead?.Medium || 'Web Form',
    campaign: lead?.Campaign || '',
    resiAddress: lead?.ResiAddress || '',
        ...
        <div className="mb-6">
          ...
          <div className="mb-4">
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium text-gray-700">lead ID :</span>
          ...
          {/* lead Tags */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">lead Tags</label>
            <div className="relative">
              <input
                type="text"
                name="tags"
