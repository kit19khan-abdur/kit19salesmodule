          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <div className="relative">
                <textarea value={message} onChange={e => setMessage(e.target.value)} className="w-full border rounded px-3 py-2 h-28" placeholder="Message" />
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 mb-4">
            ...
            <div>
              ...
              <textarea value={message} onChange={e => setMessage(e.target.value)} className="w-full border rounded px-3 py-2 h-28" placeholder="Compose SMS" />
