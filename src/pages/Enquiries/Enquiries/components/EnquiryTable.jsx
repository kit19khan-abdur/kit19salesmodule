...
const EnquiryTable = ({
  ...
  const [isMarketingSequenceModal, setIsMarketingSequenceModal] =
    useState(false);
  ...
  const [isSendIndividualMailModal, setIsSendIndividualMailModal] =
    useState(false);
  const [isSendIndividualSMSModal, setIsSendIndividualSMSModal] =
    useState(false);
  ...
  const [isAddPhysicalAppointmentModal, setIsAddPhysicalAppointmentModal] =
    useState(false);
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      if (
        massOperationRef.current &&
        !massOperationRef.current.contains(event.target)
      ) {
  ...
  const handleColumnToggle = (columnKey) => {
    ...
    if (
      (columnKey === "enquiryDetails" || columnKey === "mobileNo") &&
      ...
      if (filters[key]) {
        data = data.filter((item) => {
          ...
          if (typeof value === "boolean") {
            ...
            return (
              (value &&
                (searchLower.includes("open") ||
                  searchLower.includes("true"))) ||
              (!value &&
                (searchLower.includes("lead") || searchLower.includes("false")))
            );
          }
          // Handle other values
          return String(value ?? "")
  ...
  return (
    <div className="relative flex flex-col bg-white h-full w-full">
            ...
            {selectedEnquiries.length > 0 ? (
              <>
                <div className="bg-blue-50 border border-blue-200 rounded px-3 py-2 text-sm text-gray-700">
                  ...
                  {selectedEnquiries.length === 1 ? "enquiry" : "enquiries"}{" "}
                  selected.
                </div>
                <button
        ...
        <table className="w-full border-collapse">
          <thead className="bg-gray-50 sticky top-0 z-10">
            <tr className="border-b border-gray-200">
              ...
              {visibleColumns.enquiryDetails && (
                <th
                  className={`px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider relative group ${
                    pinnedColumn === "enquiryDetails"
                      ? "bg-blue-50 text-blue-700"
                      : "text-gray-700"
                  } ${sortConfig.key === "PersonName" ? "bg-blue-50" : ""}`}
                >
                  ...
                  <span
                    ref={(el) =>
                      (headerIconRefs.current["enquiryDetails"] = el)
                    }
                    className="inline-block ml-1 align-middle cursor-pointer"
                    onClick={(e) => {
                      e.stopPropagation();
                      setHeaderMenu(
                        headerMenu.show && headerMenu.col === "enquiryDetails"
                          ? { show: false, col: null }
                          : { show: true, col: "enquiryDetails" }
                      );
                    }}
                  >
                    {headerMenu.show && headerMenu.col === "enquiryDetails" ? (
                  ...
                  <ColumnHeaderMenu
                    ...
                    anchorRef={{
                      current: headerIconRefs.current["enquiryDetails"],
                    }}
                    ...
                    onFilter={(value) =>
                      handleFilterColumn("PersonName", value)
                    }
                    canHide={false}
                  />
                </th>
              ...
              {visibleColumns.mobileNo && (
                <th
                  className={`px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider relative group ${
                    pinnedColumn === "mobileNo"
                      ? "bg-blue-50 text-blue-700"
                      : "text-gray-700"
                  } ${sortConfig.key === "CsvMobileNo" ? "bg-blue-50" : ""}`}
                >
                  <div className="flex items-center gap-1">
                    Mobile No
                    {pinnedColumn === "mobileNo" && (
                  ...
                  <ColumnHeaderMenu
                    ...
                    onFilter={(value) =>
                      handleFilterColumn("CsvMobileNo", value)
                    }
                    canHide={false}
                  />
                </th>
              ...
              {visibleColumns.emailId && (
                <th
                  className={`px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider relative group ${
                    pinnedColumn === "emailId"
                      ? "bg-blue-50 text-blue-700"
                      : "text-gray-700"
                  } ${sortConfig.key === "CsvEmailId" ? "bg-blue-50" : ""}`}
                >
                  <div className="flex items-center gap-1">
                    Email ID
                    {pinnedColumn === "emailId" && (
                  ...
                  <ColumnHeaderMenu
                    ...
                    onFilter={(value) =>
                      handleFilterColumn("CsvEmailId", value)
                    }
                  />
                </th>
              )}
              {visibleColumns.creationDetails && (
                <th
                  className={`px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider relative group ${
                    pinnedColumn === "creationDetails"
                      ? "bg-blue-50 text-blue-700"
                      : "text-gray-700"
                  } ${sortConfig.key === "CreatedDate" ? "bg-blue-50" : ""}`}
                >
                  <div className="flex items-center gap-1">
                    Creation Details
                    {pinnedColumn === "creationDetails" && (
                  ...
                  <span
                    ref={(el) =>
                      (headerIconRefs.current["creationDetails"] = el)
                    }
                    className="inline-block ml-1 align-middle cursor-pointer"
                    onClick={(e) => {
                      e.stopPropagation();
                  ...
                  <ColumnHeaderMenu
                    ...
                    onClose={() => setHeaderMenu({ show: false, col: null })}
                    anchorRef={{
                      current: headerIconRefs.current["creationDetails"],
                    }}
                    ...
                    onFilter={(value) =>
                      handleFilterColumn("CreatedDate", value)
                    }
                  />
                </th>
              )}
                ...
                <th
                  className={`px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider relative group ${
                    pinnedColumn === "source"
                      ? "bg-blue-50 text-blue-700"
                      : "text-gray-700"
                  } ${sortConfig.key === "Source" ? "bg-blue-50" : ""}`}
                >
                  <div className="flex items-center gap-1">
                    Source
                    {pinnedColumn === "source" && (
                ...
                <th
                  className={`px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider relative group ${
                    pinnedColumn === "status"
                      ? "bg-blue-50 text-blue-700"
                      : "text-gray-700"
                  } ${sortConfig.key === "IsOpen" ? "bg-blue-50" : ""}`}
                >
                  <div className="flex items-center gap-1">
                    Status
                    {pinnedColumn === "status" && (
                  ...
                  <span
                    ref={(el) => (headerIconRefs.current["status"] = el)}
                    className="inline-block ml-1 align-middle cursor-pointer"
                    onClick={(e) => {
                      e.stopPropagation();
                      setHeaderMenu(
                        headerMenu.show && headerMenu.col === "status"
                          ? { show: false, col: null }
                          : { show: true, col: "status" }
                      );
                    }}
                  >
                    {headerMenu.show && headerMenu.col === "status" ? (
                ...
                <th
                  className={`px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider relative group ${
                    pinnedColumn === "type"
                      ? "bg-blue-50 text-blue-700"
                      : "text-gray-700"
                  } ${sortConfig.key === "Type" ? "bg-blue-50" : ""}`}
                >
                  <div className="flex items-center gap-1">
                    Type
                    {pinnedColumn === "type" && (
                  ...
                  <span
                    ref={(el) => (headerIconRefs.current["type"] = el)}
                    className="inline-block ml-1 align-middle cursor-pointer"
                    onClick={(e) => {
                      e.stopPropagation();
                      setHeaderMenu(
                        headerMenu.show && headerMenu.col === "type"
                          ? { show: false, col: null }
                          : { show: true, col: "type" }
                      );
                    }}
              ...
              {processedEnquiries.map((enquiry) => (
                <tr
                  ...
                  className={`transition hover:bg-gray-50 group ${
                    selectedLead === enquiry.EnquiryId ? "bg-blue-50" : ""
                  }`}
                >
                  <td
                    className="px-3 py-4"
                    ...
                    <td className="px-4 py-4 relative">
                      ...
                      <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <span
                          ...
                          ref={(el) =>
                            (rowMenuAnchorRefs.current[enquiry.EnquiryId] = el)
                          }
                          ...
                          onClick={(e) => {
                            ...
                            setRowMenu(
                              rowMenu.show &&
                                rowMenu.rowId === enquiry.EnquiryId
                                ? { show: false, rowId: null }
                                : { show: true, rowId: enquiry.EnquiryId }
                            );
                          }}
                        >
                      ...
                      <RowActionMenu
                        show={
                          rowMenu.show && rowMenu.rowId === enquiry.EnquiryId
                        }
                        anchorRef={{
                          current: rowMenuAnchorRefs.current[enquiry.EnquiryId],
                        }}
                        ...
                        onAction={(action) => {
                          ...
                          if (action === "sendVoice") {
                            ...
                            alert(
                              `Action: ${action} for ${enquiry.PersonName} and Id ${enquiry.EnquiryId}`
                            );
                          }
                        }}
                      />
          ...
          {getPaginationNumbers().map((page, index) =>
            page === "..." ? (
              <span
                ...
                onClick={() =>
                  setShowPagePopup(showPagePopup === index ? null : index)
                }
              >
                ...
                {showPagePopup === index && (
                  ...
                  >
                    {getAllPageNumbers().map((page) => (
                      <button
                        ...
                        className={`w-full h-8 text-center rounded text-sm font-medium transition ${
                          currentPage === page
                            ? "bg-blue-600 text-white"
                            : "text-gray-700 hover:bg-gray-100"
                        }`}
      ...
      <PopUpModal
        ...
        footer={
          <div className="flex justify-between w-full">
            <Button variant="secondary" onClick={handleCancelLeadModal}>
              Cancel
            </Button>
      ...
      <PopUpModal
        ...
        footer={
          <div className="flex justify-between w-full">
            <Button variant="secondary" onClick={handleCancelSMSModal}>
              Cancel
            </Button>
      ...
      <PopUpModal
        ...
        footer={
          <div className="flex justify-between w-full">
            <Button variant="secondary" onClick={handleCancelMailModal}>
              Cancel
            </Button>
      ...
      <PopUpModal
        ...
        footer={
          <div className="flex justify-between w-full">
            <Button variant="secondary" onClick={handleCancelSequenceModal}>
              Cancel
            </Button>
      ...
      <PopUpModal
        ...
        footer={
          <div className="flex justify-between w-full">
            ...
            <Button variant="primary" onClick={handleSendInternationalSMS}>
              Send SMS
            </Button>
          </div>
        }
      >
        <InternalSMSForm
          onClose={handleCancelInternationalSMSModal}
          onSubmit={handleSendInternationalSMS}
        />
      </PopUpModal>
      ...
      <PopUpModal
        ...
        footer={
          <div className="flex justify-between w-full">
            <Button variant="secondary" onClick={handleCancelCallListModal}>
              Cancel
            </Button>
            <Button variant="primary" onClick={handleSaveCallList}>
              Save
            </Button>
          </div>
        }
      ...
      <PopUpModal
        ...
        footer={
          <div className="flex justify-between w-full">
            <Button variant="secondary" onClick={handleCancelTagModal}>
              Cancel
            </Button>
      ...
      <PopUpModal
        ...
        footer={
          <div className="flex justify-between w-full">
            <Button variant="secondary" onClick={handleCancelRemoveTagModal}>
              Cancel
            </Button>
            <Button variant="primary" onClick={handleSaveRemoveTag}>
              Remove Tag
            </Button>
          </div>
        }
      ...
      <PopUpModal
        ...
        footer={
          <div className="flex justify-between w-full">
            <Button variant="secondary" onClick={handleCancelIndividualMail}>
              Cancel
            </Button>
            <Button variant="primary" onClick={handleSendIndividualMail}>
              Send Mail
            </Button>
          </div>
        }
      ...
      <PopUpModal
        ...
        footer={
          <div className="flex justify-between w-full">
            <Button variant="secondary" onClick={handleCancelIndividualSMS}>
              Cancel
            </Button>
            <Button variant="primary" onClick={handleSendIndividualSMS}>
              Send SMS
            </Button>
          </div>
        }
      ...
      <PopUpModal
        ...
        footer={
          <div className="flex justify-between w-full">
            <Button variant="secondary" onClick={handleCancelVoice}>
              Cancel
            </Button>
            <Button variant="primary" onClick={handleSendVoice}>
              Send Voice
            </Button>
          </div>
        }
        ...
        footer={
          <>
            ...
            <Button
              ...
              onClick={() => {
                alert(
                  `Confirmed deletion (no handler wired). Enquiry ID: ${deleteConfirmModal.enquiryId}`
                );
                setDeleteConfirmModal({ show: false, enquiryId: null });
              }}
            >
      ...
      >
        <p className="text-gray-700">
          ...
          <strong>{deleteConfirmModal.enquiryId}</strong>?
        </p>
      </Modal>
    </div>
  );
