...
const EditAppointment = ({ appointment }) => {
    const [formData, setFormData] = useState({
        ...
        appointmentType: appointment?.appointmentType || 'service',
        dueDate: appointment?.dueDate || '',
        relatedTo: appointment?.relatedTo || '',
        owner: appointment?.owner || '',
        collaborators: appointment?.collaborators || [],
        markAsCompleted: appointment?.status === 'completed' || false,
    ...
    const [relatedToSearch, setRelatedToSearch] = useState(appointment?.relatedTo || '');
        ...
        <div className="space-y-5">
            ...
            <div>
                ...
                <input
                    ...
                    placeholder="Create Appointment Test - 2026-01-28 15:29:07"
            ...
            <div>
                ...
                <div className="relative">
                    <textarea
                        ...
                        onChange={handleChange}
                        placeholder="This is an appointment creation test for Create Appointment Test - 2026-01-28 15:29:07"
                        rows={3}
            ...
            {/* Appointment Type, Due Date, Related To - 3 columns */}
            ...
            {formData.markAsCompleted &&(<div>
                ...
                <div className="relative">
                    <textarea
                        ...
                        onChange={handleChange}
                        placeholder="about the appointment..."
                        rows={3}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-600 resize-y"
                    /></div>
            </div>)}
