...
const AppointmentFilters = ({ filters, setFilters, totalCounts }) => {
        ...
        <div className="flex items-center gap-6">
            ...
            <label className="flex items-center gap-2 cursor-pointer group">
                ...
                <span className={`flex items-center gap-1 text-sm font-medium transition-colors ${
                    ...
                    <appointmentStatusConfig.open.icon className={`w-5 h-5 ${appointmentStatusConfig.open.color}`} />
                    Open
                </span>
            </label>
            ...
            <label className="flex items-center gap-2 cursor-pointer group">
                ...
                <span className={`flex items-center gap-1 text-sm font-medium transition-colors ${
                    ...
                    <appointmentStatusConfig.overdue.icon className={`w-5 h-5 ${appointmentStatusConfig.overdue.color}`} />
                    Overdue
                </span>
            </label>
            ...
            <label className="flex items-center gap-2 cursor-pointer group">
                ...
                <span className={`flex items-center gap-1 text-sm font-medium transition-colors ${
                    ...
                    <appointmentStatusConfig.completed.icon className={`w-5 h-5 ${appointmentStatusConfig.completed.color}`} />
                    Completed
                </span>
            </label>
